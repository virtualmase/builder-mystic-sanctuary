...
const experiences = [
  ...
  },
  {
    ...
    type: "Full-time",
    description:
      "Optimized technical aspects of Kraken's digital properties to increase organic search performance, acting as consultant for content, UX, and growth marketing teams while driving significant organic traffic growth.",
    achievements: [
      "Increased organic traffic by 85% through comprehensive technical SEO optimization",
      "Implemented hreflang methods and reduced technical debt across multiple web properties",
      "Built automated SEO dashboards and reports improving team effectiveness by 60%",
      "Consulted with product, engineering, and UX teams on technical SEO opportunities",
      "Conducted technical audits improving site health and page load performance by 40%",
      "Automated SEO tasks and troubleshooting processes for scalable operations",
    ],
    technologies: [
