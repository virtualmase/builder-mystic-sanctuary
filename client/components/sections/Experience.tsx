...
const experiences = [
  {
    ...
    type: "Founder & Lead",
    description:
      "Founded R&D laboratory building modern web applications using cutting-edge platforms like Vercel, Supabase, and Neon. Architected full-stack solutions with 'Archie' AI system, leveraging v0 for rapid prototyping and Builder.io-style development workflows across infrastructure, compute, and interface layers.",
    achievements: [
      "Built 9+ production applications using Vercel, Supabase, and modern development platforms",
      "Developed 'Archie' AI system with real-time dashboards using Neon database infrastructure",
      "Leveraged v0, Cursor, and AI-powered development tools for rapid prototyping and deployment",
      "Created scalable web applications with serverless architecture and edge computing",
      "Implemented modern CMS workflows similar to Builder.io and Contentful ecosystems",
      "Built comprehensive analytics platforms with real-time data visualization capabilities",
    ],
    technologies: ["Vercel", "Supabase", "Neon", "v0", "React/Next.js"],
  },
  {
